$_mod.def("/@pnidem/first-mate$5.2.0/lib/injections", function(require, exports, module, __filename, __dirname) { (function() {
  var Injections, Scanner, ScopeSelector, _;

  _ = require('/underscore-plus$1.6.6/lib/underscore-plus'/*'underscore-plus'*/);

  Scanner = require('/@pnidem/first-mate$5.2.0/lib/scanner'/*'./scanner'*/);
