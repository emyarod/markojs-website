$_mod.def("/@pnidem/first-mate$5.2.0/lib/grammar", function(require, exports, module, __filename, __dirname) { (function() {
  ...
  Emitter = require('/event-kit$2.2.0/lib/event-kit'/*'event-kit'*/).Emitter;

  Grim = {}/*require('grim')*/;

  Injections = require('/@pnidem/first-mate$5.2.0/lib/injections'/*'./injections'*/);

  Pattern = require('/@pnidem/first-mate$5.2.0/lib/pattern'/*'./pattern'*/);

  Rule = require('/@pnidem/first-mate$5.2.0/lib/rule'/*'./rule'*/);

  ScopeSelector = require('/@pnidem/first-mate$5.2.0/lib/scope-selector'/*'./scope-selector'*/);
