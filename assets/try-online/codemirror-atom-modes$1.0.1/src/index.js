$_mod.def("/codemirror-atom-modes$1.0.1/src/index", function(require, exports, module, __filename, __dirname) { 'use strict';

var firstMate = require('/@pnidem/first-mate$5.2.0/lib/first-mate'/*'@pnidem/first-mate'*/);
