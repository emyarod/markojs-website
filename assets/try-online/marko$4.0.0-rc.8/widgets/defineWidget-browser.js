$_mod.def("/marko$4.0.0-rc.8/widgets/defineWidget-browser", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */
...
BaseState = require('/marko$4.0.0-rc.8/widgets/State'/*'./State'*/);
BaseWidget = require('/marko$4.0.0-rc.8/widgets/Widget'/*'./Widget'*/);
