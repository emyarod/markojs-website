$_mod.def("/marko$4.0.0-rc.5/widgets/event-delegation", function(require, exports, module, __filename, __dirname) { var widgetLookup = require('/marko$4.0.0-rc.5/widgets/util-browser'/*'./util'*/).$__widgetLookup;
...
function attachBubbleEventListeners(doc) {
    ...
    require('/marko$4.0.0-rc.5/widgets/bubble'/*'./bubble'*/).forEach(function addBubbleHandler(eventType) {
