$_mod.def("/marko$4.0.0-rc.5/widgets/Widget", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var domInsert = require('/marko$4.0.0-rc.5/runtime/dom-insert'/*'../runtime/dom-insert'*/);
var marko = require('/marko$4.0.0-rc.5/runtime/index'/*'../'*/);
...
var RenderResult = require('/marko$4.0.0-rc.5/runtime/RenderResult'/*'../runtime/RenderResult'*/);
...
var updateManager = require('/marko$4.0.0-rc.5/widgets/update-manager'/*'./update-manager'*/);
var morphAttrs = require('/marko$4.0.0-rc.5/runtime/vdom/HTMLElement'/*'../runtime/vdom/HTMLElement'*/).$__morphAttrs;
