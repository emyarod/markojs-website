$_mod.def("/marko$4.0.0-rc.12/taglibs/core/if-tag", function(require, exports, module, __filename, __dirname) { module.exports = function nodeFactory(elNode, context) {
