$_mod.def("/marko$4.0.0-rc.12/widgets/taglib/TransformHelper/handleWidgetFor", function(require, exports, module, __filename, __dirname) { module.exports = function handleWidgetFor() {
    var el = this.el;
