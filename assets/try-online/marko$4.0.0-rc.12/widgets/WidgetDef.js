$_mod.def("/marko$4.0.0-rc.12/widgets/WidgetDef", function(require, exports, module, __filename, __dirname) { 'use strict';
var nextRepeatedId = require('/marko$4.0.0-rc.12/widgets/nextRepeatedId'/*'./nextRepeatedId'*/);
var repeatedRegExp = /\[\]$/;
var nextWidgetId = require('/marko$4.0.0-rc.12/widgets/util-browser'/*'./util'*/).$__nextWidgetId;
var extend = require('/raptor-util$3.1.0/extend'/*'raptor-util/extend'*/);
var registry = require('/marko$4.0.0-rc.12/widgets/registry-browser'/*'./registry'*/);
