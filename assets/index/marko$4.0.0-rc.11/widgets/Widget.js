$_mod.def("/marko$4.0.0-rc.11/widgets/Widget", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var domInsert = require('/marko$4.0.0-rc.11/runtime/dom-insert'/*'../runtime/dom-insert'*/);
var marko = require('/marko$4.0.0-rc.11/runtime/index'/*'../'*/);
...
var RenderResult = require('/marko$4.0.0-rc.11/runtime/RenderResult'/*'../runtime/RenderResult'*/);
...
var updateManager = require('/marko$4.0.0-rc.11/widgets/update-manager'/*'./update-manager'*/);
var morphAttrs = require('/marko$4.0.0-rc.11/runtime/vdom/VElement'/*'../runtime/vdom/VElement'*/).$__morphAttrs;
