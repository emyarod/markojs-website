$_mod.def("/marko$4.0.0-rc.3/widgets/init-widgets-browser", function(require, exports, module, __filename, __dirname) { 'use strict';
var warp10Finalize = require('/warp10$1.3.3/finalize'/*'warp10/finalize'*/);
var eventDelegation = require('/marko$4.0.0-rc.3/widgets/event-delegation'/*'./event-delegation'*/);
var win = window;
var defaultDocument = document;
var events = require('/marko$4.0.0-rc.3/runtime/events'/*'../runtime/events'*/);
...
var WidgetDef = require('/marko$4.0.0-rc.3/widgets/WidgetDef'/*'./WidgetDef'*/);
...
registry = require('/marko$4.0.0-rc.3/widgets/registry'/*'./registry'*/);
