$_mod.def("/marko$4.0.0-rc.3/widgets/Widget", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var domInsert = require('/marko$4.0.0-rc.3/runtime/dom-insert'/*'../runtime/dom-insert'*/);
var marko = require('/marko$4.0.0-rc.3/runtime/index'/*'../'*/);
...
var RenderResult = require('/marko$4.0.0-rc.3/runtime/RenderResult'/*'../runtime/RenderResult'*/);
...
var updateManager = require('/marko$4.0.0-rc.3/widgets/update-manager'/*'./update-manager'*/);
var morphAttrs = require('/marko$4.0.0-rc.3/runtime/vdom/HTMLElement'/*'../runtime/vdom/HTMLElement'*/).$__morphAttrs;
