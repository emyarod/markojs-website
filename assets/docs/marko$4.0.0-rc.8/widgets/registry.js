$_mod.def("/marko$4.0.0-rc.8/widgets/registry", function(require, exports, module, __filename, __dirname) { var loadWidget = require('/marko$4.0.0-rc.8/widgets/loadWidget-dynamic'/*'./loadWidget'*/);
...
defineWidget = require('/marko$4.0.0-rc.8/widgets/defineWidget-browser'/*'./defineWidget'*/);
defineRenderer = require('/marko$4.0.0-rc.8/widgets/defineRenderer'/*'./defineRenderer'*/);
});