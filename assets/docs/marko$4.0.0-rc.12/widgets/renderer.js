$_mod.def("/marko$4.0.0-rc.12/widgets/renderer", function(require, exports, module, __filename, __dirname) { var widgetLookup = require('/marko$4.0.0-rc.12/widgets/util-browser'/*'./util'*/).$__widgetLookup;
