$_mod.def("/marko$4.0.0-rc.5/widgets/WidgetDef", function(require, exports, module, __filename, __dirname) { 'use strict';
var nextRepeatedId = require('/marko$4.0.0-rc.5/widgets/nextRepeatedId'/*'./nextRepeatedId'*/);
var repeatedRegExp = /\[\]$/;
var nextWidgetId = require('/marko$4.0.0-rc.5/widgets/util-browser'/*'./util'*/).$__nextWidgetId;
